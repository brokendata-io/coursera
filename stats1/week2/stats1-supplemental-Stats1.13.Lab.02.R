...
impact <- read.table("lab2datafile.txt", header = T) 
...
describeBy(impact, impact$condition) # condition was either control or concussed 

# Subsetting
edit(impact)

control <- subset(impact, impact[, 2]=="control")
# subset takes 2 arguments, what frame you want to subset, and what you want to subset by 
control
